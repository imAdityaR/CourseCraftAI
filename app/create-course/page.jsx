...
import TopicDescription from "./_components/Topic";
import SelectOption from "./_components/Options";
...
const CreateCourse = () => {
  ...
  const GenerateCourseLayout = async () => {
    ...
    const USER_INPUT_PROMPT = `Category: ${userCourseInput?.category}, Topic: ${userCourseInput?.topic}, Description:${userCourseInput?.description} , Level:${userCourseInput?.difficulty}, Duration: ${userCourseInput?.duration}, NoOf Chapters:${userCourseInput?.chapters}`
  ...
  const SaveCourseLayoutInDb = async (courseLayout) => {
    ...
    const res = await db.insert(CourseList).values({
      ...
      includeVideo:userCourseInput?.addVideo
    })
    console.log("Finish");
    setLoading(false);
